...
public class hideandsee : MonoBehaviour
{
    ...
    public GameObject half7;
    public GameObject half8;
    ...
    void Start()
    {
        ...
        half7.SetActive(false);
        half8.SetActive(false);
        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            if (Physics.Raycast(ray, out hit))
            {
                ...
                if (bc != null)
                {
                    ...
                    else if (bc.gameObject == item7)
                    {
                        item7.SetActive(false);
                        half7.SetActive(true);
                    }
                    else if (bc.gameObject == item8)
                    {
                        item8.SetActive(false);
                        half8.SetActive(true);
                    }
                    ...
                    else if (bc.gameObject == half7)
                    {
                        half7.SetActive(false);
                        chair7.SetActive(true);
                    }
                    else if (bc.gameObject == half8)
                    {
                        half8.SetActive(false);
